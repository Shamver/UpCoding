...
public class Oauth2Controller {
    ...
    public String login_success(Model model, OAuth2AuthenticationToken authentication){
        ...
        if(!StringUtils.isEmpty(userInfoEndpointUri)){
            ...
            ResponseEntity<Map> response = restTemplate.exchange(siteUrlCustom(authentication.getAuthorizedClientRegistrationId(), userInfoEndpointUri), HttpMethod.GET, entity, Map.class);
